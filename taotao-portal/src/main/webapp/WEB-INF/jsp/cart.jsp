...
<div class="w w1 header clearfix">
	<div id="logo"><a href="/"><img clstag="clickcart|keycount|xincart|logo" src="/images/taotao-logo.gif" title="返回淘乐购商城首页" alt="返回淘乐购商城首页"></a></div>
...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        ...
        <div class="column t-price">淘乐购价</div>
    ...
    <div id="product-list" class="cart-tbody">
        ...
        <c:forEach items="${cartList}" var="cart">
          ...
          <div class="cart-toolbar clearfix">
            ...
            <div class="amout fr"><span id="selectedCount">${cartList.size()}</span> 种商品</div>
        </div>
              ...
              <div class="cart-button">
                  ...
                  <span class="combine-btns" style="display:none">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          <a href="javascript:goToOverseaOrder();" class="checkout-jdInt">去淘乐购国际结算<b></b></a>
                          <a href="javascript:goToOrder();" class="checkout-jd">去淘乐购结算<b></b></a>
                      </span>
                  </span>
              </div>
              <div class="total fr">
